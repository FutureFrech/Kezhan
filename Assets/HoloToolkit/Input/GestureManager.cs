...
namespace Academy.HoloToolkit.Unity
{
    ...
    public class GestureManager : Singleton<GestureManager>
    {
        ...
        public UnityEngine.VR.WSA.Input.GestureRecognizer ClickRecognizer { get; private set; }
        public UnityEngine.VR.WSA.Input.GestureRecognizer MoveRecognizer { get; private set; }
        public UnityEngine.VR.WSA.Input.GestureRecognizer RotateRecognizer { get; private set; }
        public UnityEngine.VR.WSA.Input.GestureRecognizer ZoomRecognizer { get; private set; }
        public UnityEngine.VR.WSA.Input.GestureRecognizer SaveRecognizer { get; private set; }
        public UnityEngine.VR.WSA.Input.GestureRecognizer ActiveRecognizer { get; private set; }
        ...
        #region GestureEvent
        // Click Gesture
        private void ClickRecognizer_TappedEvent(UnityEngine.VR.WSA.Input.InteractionSourceKind source, int tapCount, Ray headRay)
        {
            focusedObject.SendMessage("OnSelect");
        }

        private void SaveRecognizer_TappedEvent(UnityEngine.VR.WSA.Input.InteractionSourceKind source, int tapCount, Ray headRay)
        {
        ...
        // Move Gesture
        private void MoveRecognizer_ManipulationStartedEvent(UnityEngine.VR.WSA.Input.InteractionSourceKind source, Vector3 position, Ray ray)
        {
            IsManipulating = true;
        ...
        private void MoveRecognizer_ManipulationUpdatedEvent(UnityEngine.VR.WSA.Input.InteractionSourceKind source, Vector3 position, Ray ray)
        {
            IsManipulating = true;
        ...
        private void MoveRecognizer_ManipulationCompletedEvent(UnityEngine.VR.WSA.Input.InteractionSourceKind source, Vector3 position, Ray ray)
        {
        ...
        private void MoveRecognizer_ManipulationCanceledEvent(UnityEngine.VR.WSA.Input.InteractionSourceKind source, Vector3 position, Ray ray)
        {
            IsManipulating = false;
            if (handleObj != null)
            {
        ...
        // Rotate Gesture
        private void RotateRecognizer_NavigationStartedEvent(UnityEngine.VR.WSA.Input.InteractionSourceKind source, Vector3 relativePosition, Ray ray)
        {
            IsNavigating = true;
            InitialHandleObject(focusedObject);      
        }

        private void RotateRecognizer_NavigationUpdatedEvent(UnityEngine.VR.WSA.Input.InteractionSourceKind source, Vector3 relativePosition, Ray ray)
        {        
            IsNavigating = true;
        ...
        private void RotateRecognizer_NavigationCompletedEvent(UnityEngine.VR.WSA.Input.InteractionSourceKind source, Vector3 relativePosition, Ray ray)
        {
            IsNavigating = false;
            FreeHandleObject();
            ShowCursorHoldingFeedback(false);
        ...
        private void RotateRecognizer_NavigationCanceledEvent(UnityEngine.VR.WSA.Input.InteractionSourceKind source, Vector3 relativePosition, Ray ray)
        {
            IsNavigating = false;
            if (handleObj != null)
            {
        ...
        // Zoom Gesture
        private void ZoomRecognizer_NavigationStartedEvent(UnityEngine.VR.WSA.Input.InteractionSourceKind source, Vector3 relativePosition, Ray ray)
        {
            IsZooming = true;
            InitialHandleObject(focusedObject);
        }

        private void ZoomRecognizer_NavigationUpdatedEvent(UnityEngine.VR.WSA.Input.InteractionSourceKind source, Vector3 relativePosition, Ray ray)
        {
            IsZooming = true;
        ...
        private void ZoomRecognizer_NavigationCompletedEvent(UnityEngine.VR.WSA.Input.InteractionSourceKind source, Vector3 relativePosition, Ray ray)
        {
            IsZooming = false;
            FreeHandleObject();
            ShowCursorHoldingFeedback(false);
        ...
        private void ZoomRecognizer_NavigationCanceledEvent(UnityEngine.VR.WSA.Input.InteractionSourceKind source, Vector3 relativePosition, Ray ray)
        {
            IsZooming = false;
            if (handleObj != null)
            {
